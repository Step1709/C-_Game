...
namespace Entities.MainPlayers
{
    public class Brightfire : MainPlayer
    {
        ...
        private Brightfire()
        {
            ...
            EntityPrefab = Resources.Load<GameObject>("Prefabs/Player_Heal_Prefab");
            MoveSpeed = 7f;
            Name = "Brightfire";
            MaxTileCount = 9;
            Icon = Resources.Load<Sprite>("Icons/BrightIcon");
            var weapon1 = new HealWeapon(5, 10, 1.5f, 0f, true, "atack1");
            weapon1.Icon = Resources.Load<Sprite>("Icons/heal1");
            ...
            var weapon2 = new HealWeapon(3, 7, 10f, 2.5f, true, "Atack2");
