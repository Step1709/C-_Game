...
namespace Weapons
{
    ...
    {
        public HealWeapon(int minDamage, int maxDamage, float range, float splashRadius, bool damageSelf, string animationName) 
        ...
        protected override void Damage(Entity user, Entity target)
        {
            ...
            UI.Screen.Instance.DamageShower.ShowDamage(target, damage.ToString(), Color.green, new Vector3(0,0.6f,0));
        ...
        public override bool Use(Enemy enemy)
        {
            ...
            {
                var exceptColliders = Physics2D.OverlapCircleAll(entity.GameObject.transform.position, 0.1f)
                    .ToHashSet();
