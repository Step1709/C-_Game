...
namespace Weapons
{
    ...
    {
        public HealWeapon(int minDamage, int maxDamage, float range, float splashRadius, bool damageSelf, string imagePath) 
        ...
        public override bool Use(Enemy enemy)
        {
            ...
            foreach (var entity in GameModel.Instance.Enemies)
            {
                ...
                if (currentpath != null && entity.Health <= 10  && entity.Health<=minHealth)
                {
                    path = currentpath;
